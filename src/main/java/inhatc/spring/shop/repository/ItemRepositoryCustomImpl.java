...
import static inhatc.spring.shop.entity.QItem.*;

/**
 * packageName    : inhatc.spring.shop.repository
 * fileName       : ItemRepositoryCustomImpl
 * author         : TaeJeongPark
 * date           : 2023-11-29
 * description    :
 * ===========================================================
...
public class ItemRepositoryCustomImpl implements ItemRepositoryCustom  {
    ...
    private BooleanExpression searchByLike(String searchBy, String searchQuery) {
        if(StringUtils.equals("itemName", searchBy)){
            ...
            return item.createBy.like("%" + searchQuery + "%");  // 검색어가 createdBy이면 createdBy에 검색어가 포함되어 있는지 반환
        }
        return null;
    }
}